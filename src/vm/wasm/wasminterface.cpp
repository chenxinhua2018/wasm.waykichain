...
//rhf_t::add<WasmHostMethods, &WasmHostMethods::print_num, wasm_allocator>("env", "print_num");
   rhf_t::add<WasmHostMethods, &WasmHostMethods::abort, wasm_allocator>("env", "abort");
   // rhf_t::add<WasmHostMethods, &WasmHostMethods::eosio_assert, wasm_allocator>("env", "eosio_assert");
   // rhf_t::add<WasmHostMethods, &WasmHostMethods::eosio_assert_code, wasm_allocator>("env", "eosio_assert_code");
   ...
   //rhf_t::add<WasmHostMethods, &WasmHostMethods::print_name, wasm_allocator>("env", "print_name");
