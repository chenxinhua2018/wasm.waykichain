...
string CWasmContractTx::ToString(CAccountDBCache &view) {
    CKeyID senderKeyId;
...
Object CWasmContractTx::ToJson(const CAccountDBCache &view) const{
    Object object;
    ...
    object.push_back(Pair("valid_height", nValidHeight));
    return object;
}
