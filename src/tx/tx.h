...
public:
    ...
    CBaseTx& operator=(const CBaseTx& other) {
        if (this == &other) return *this;

        this->nMinTxFee       = other.nMinTxFee;
        this->nMinRelayTxFee  = other.nMinRelayTxFee;
        this->nDustAmountThreshold = other.nDustAmountThreshold;
        // this->CURRENT_VERSION      = other.CURRENT_VERSION;
        this->nVersion             = other.nVersion;

        this->nTxType              = other.nTxType;
        this->txUid                = other.txUid;
        this->nValidHeight         = other.nValidHeight;
        this->llFees               = other.llFees;
        this->signature            = other.signature;
        
        this->nRunStep             = other.nRunStep;
        this->nFuelRate            = other.nFuelRate;
